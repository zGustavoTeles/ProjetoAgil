...
public class Suporte extends totalcross.ui.Window{
	...
	public void initUI() {
		...
		try {
			...
			multInfoEmail.setRect(LEFT + 2, AFTER + 10, SCREENSIZE + 100, SCREENSIZE + 45, imgSuporte);
            ...
            btnEnviarEmail = BottomImg.imageWithText(new Image("img/enviar.png"), "Enviar", Button.BOTTOM);
			add(btnEnviarEmail, LEFT, BOTTOM, SCREENSIZE + 25, PREFERRED + 10);
			btnEnviarEmail.setBackColor(0x1c355d);
			...
			case ControlEvent.PRESSED:
				...
				if (evt.target == btnVoltar) {
					...
					if (multInfoEmail.getText().equals("")) {
						Auxiliares.messagebox("AGIL", "Deve-se inscrever algo na mensagem!");
						return;
					}

					String[] ArtButtonArray = { "Sim", "Não" };

					int i = Auxiliares.messageBox("AGIL", "Deseja enviar a mensagem para o suporte?",
							ArtButtonArray);
	...
	private void enviaEmail() {
		...
		try {
			...
			ProgressBox pb = new ProgressBox("AGIL", "Enviando Mensagem...", null);
