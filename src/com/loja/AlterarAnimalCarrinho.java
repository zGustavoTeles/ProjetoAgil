...
public class AlterarAnimalCarrinho extends totalcross.ui.Window {
	...
	public AlterarAnimalCarrinho() {
		super("ALTERAR ANIMAL NO CARRINHO", TAB_ONLY_BORDER);
	...
	public void initUI() {
		...
		try {
			...
			imgAlteraAnimalCarrinho = new ImageControl(new Image("img/alterarAnimalCarrinho.png"));
			imgAlteraAnimalCarrinho.scaleToFit = true;
			imgAlteraAnimalCarrinho.centerImage = true;
			add(imgAlteraAnimalCarrinho, LEFT + 10, TOP + 50, SCREENSIZE + 35, SCREENSIZE + 55);
...
//			lblCategoria.setForeColor(Color.WHITE);
			...
			add(editDescricao);
			editDescricao.setRect(CENTER + 190, TOP + 70, SCREENSIZE + 50, SCREENSIZE + 6, imgAlteraAnimalCarrinho);
...
//			lblTotal.setForeColor(Color.WHITE);
			...
			add(btnAlterar, LEFT, BOTTOM, SCREENSIZE + 25, PREFERRED + 10);
